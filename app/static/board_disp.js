...
function dragStartHandle(e) {
    ...
    var shouldBeIgnored = elementsAtPos.find((x) => x.classList.contains('option-dropdown-comp') || 
    ...
    var parentStatusBox = elementsAtPos.find((x) => x.classList.contains('flex-status'));
    if (parentStatusBox) {
